...
export default function HomePage({ onExploreClick }) {
  return (
    <div className="min-h-screen bg-slate-950 text-white flex flex-col justify-between relative overflow-hidden px-4 sm:px-6 lg:px-8">
      {/* Enhanced Background Lighting Orbs */}
      <div className="absolute top-10 left-1/2 -translate-x-1/2 w-[500px] h-[500px] bg-gradient-to-tr from-red-600/20 to-amber-500/20 rounded-full blur-[120px] pointer-events-none" />
      ...
      <div className="max-w-4xl mx-auto text-center pt-16 pb-12 relative z-10 flex-1 flex flex-col justify-center items-center">
        ...
        <h1 className="text-4xl sm:text-6xl md:text-7xl font-black tracking-tight text-white leading-[1.15]">
          ...
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-red-500 via-amber-400 to-orange-500">
            FAVORITE SHOW
          </span>
        </h1>
        ...
        <div className="mt-8 flex flex-col sm:flex-row gap-4 items-center justify-center">
          <button
            ...
            className="w-full sm:w-auto bg-gradient-to-r from-red-600 to-amber-500 hover:from-red-500 hover:to-amber-400 text-white font-bold text-lg px-8 py-4 rounded-xl shadow-xl shadow-red-600/30 hover:shadow-red-500/50 transition-all transform hover:-translate-y-0.5 active:translate-y-0"
          >
            Explore Catalog 🚀
          </button>
        </div>
        ...
        <div className="mt-16 grid grid-cols-3 gap-6 sm:gap-12 border-t border-slate-800/80 pt-8 max-w-2xl w-full">
          ...
          <div>
            <p className="text-2xl sm:text-3xl font-extrabold text-amber-400">4.8★</p>
      ...
      <div className="max-w-6xl mx-auto w-full pb-16 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-slate-900/60 border border-slate-800 hover:border-slate-700 p-6 rounded-2xl backdrop-blur-md transition-all hover:-translate-y-1 group">
            <div className="w-12 h-12 bg-amber-500/10 border border-amber-500/20 rounded-xl flex items-center justify-center text-2xl mb-4 text-amber-400 group-hover:scale-110 transition-transform">
              ⭐
            </div>
